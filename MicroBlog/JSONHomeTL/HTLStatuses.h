...
@class HTLRetweetedStatus, HTLUser, HTLVisible;

@interface HTLStatuses : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, strong) HTLRetweetedStatus *retweetedStatus;
